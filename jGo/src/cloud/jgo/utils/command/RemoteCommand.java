...
public class RemoteCommand extends LocalCommand {
	...
	public RemoteCommand(String command, String help, Execution execution) {
		...
		/*
		 * 
		 * JGO Auto-generated constructor stub Author : £ wasp91 £ Date 03 gen 2018
		 * 
		 */
	}
		...
		if (indexFirstSpace == -1) {
			...
			for (int i = 0; i < split.length; i++) {
				...
				case 2:
					...
					// sono semplicemente param value e il valore è senza spazi per esempio : name
					// Marco e non name Marco Piero, chiaro ?
					param = splitForSpace[0];
