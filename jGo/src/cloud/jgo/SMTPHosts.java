...
/**
 * 
 * @author Martire91 This class is a collection of smtp hosts Facilitates the
 *         use of jGo methods to send emails.
 */
public class SMTPHosts extends Hashtable<String, SMTPHosts.SMTPEntry> {
	private static SMTPHosts instance = null;

	// mi costruisco un costruttore privato, cosi non faccio creare instanze di
	// questa classe
	private SMTPHosts() {
		// gmail
	...
	/**
	 * @author Martire91 This class represents a simple entry smtp.
	 */
