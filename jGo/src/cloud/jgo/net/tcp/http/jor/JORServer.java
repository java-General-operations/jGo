 ...
 * @version 1.0.3
   ...
   <img id='logo'src='https://www.jgo.cloud/jgo2/' alt='logo jgo' width='50px' height='50px'><br>
   <strong>Description :</strong><br> This technology allows you to represent java objects on the web.<br>
     ...
     <li>Apply the JOR annotation to the class of the object you want to represent</li>
     <li>Implement the methods if necessary: {@link JORHandlerConnection#html_represents(Object, cloud.jgo.net.tcp.http.HTTPResponse, String)}-{@link JORHandlerConnection#organizesObjectsRootPage(java.util.Map, cloud.jgo.net.tcp.http.HTTPResponse, String)}</li>
     </ol>
     <br><br>
     Here is the url for general documentation :<br>
     <a href='https://www.jgo.cloud/jor'>https://www.jgo.cloud/jor</a><br><br><br>
   <strong>JOR :</strong><br>
   <strong>J</strong> - <em>Java</em><br>
   <strong>O</strong> - <em>Object</em><br>
   <strong>R</strong> - <em>Rappresentation</em><br><br>
   This class represents a server with jor technology,
   is an implementation of {@link HTTPServer}
*/
