...
public abstract class Header {
	...
	public static class Type {
		...
		private final static Type[]availableTypes = {ACCEPT,ACCEPT_ENCODING,ACCEPT_LANGUAGE,USER_AGENT,CONTENT_LENGTH,CONTENT_ENCODING
		,CONTENT_TYPE,CACHE_CONTROL,CONNECTION,LAST_MODIFIED,SERVER,X_POWERED_BY,PRAGMA,REFRESH,HOST};
...
refresh: specifica il numero di secondi trascorsi i quali il browser deve richiedere un aggiornamento della pagina
	 ...
	 * @return the header
	 * @throws MimeTypeParseException 1 exception
	 */
