...
public class ResponseCode {
	...
	// perché è stata spostata in modo permanente.
	// 302 Found. La risorsa è raggiungibile con un altro URI indicato nel header
	// Location. Di norma i browser eseguono la richiesta all'URI indicato in modo
	...
	// l'ubicazione. Di solito avviene quando l'URI è stato indicato in modo
	// incorretto, oppure è stato rimosso il contenuto dal server.
	...
	public final static ResponseCode RESPONSE_NOT_SUPPORTED_VERSION = new ResponseCode(505,
