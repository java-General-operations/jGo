...
public class TCPLoginServerConfiguration extends TCPServerConfiguration {
	public final static ConfigurationKey PASSW = new ServerConfiguration.ServerConfigurationKey("jgo.net.server_passw",
			String.class, TCPLoginServerConfiguration.class);
	public final static ConfigurationKey USER = new ServerConfiguration.ServerConfigurationKey("jgo.net.server_user",
			String.class, TCPLoginServerConfiguration.class);
	public final static ConfigurationKey ATTEMPTS = new ServerConfiguration.ServerConfigurationKey(
			"jgo.net.server_attempts", Integer.class, TCPLoginServerConfiguration.class);
	public final static ConfigurationKey AES_KEY = new ServerConfiguration.ServerConfigurationKey(
			"jgo.net.server.aes_key", String.class, TCPLoginServerConfiguration.class);
	static {
