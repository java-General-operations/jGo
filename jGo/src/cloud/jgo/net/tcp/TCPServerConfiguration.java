...
public class TCPServerConfiguration extends ServerConfiguration {
	...
	public final static ConfigurationKey MULTI_CONNECTIONS = new ServerConfiguration.ServerConfigurationKey(
			"jgo.net.server.multi_connections", Boolean.class, TCPServerConfiguration.class);
	public final static ConfigurationKey ACCEPTED_SOCKET = new ServerConfiguration.ServerConfigurationKey(
			"jgo.net.server.accepted_socket", String.class, TCPServerConfiguration.class);
	public final static ConfigurationKey MAXIMUM_SOCKETS = new ServerConfiguration.ServerConfigurationKey(
			"jgo.net.server.maximum_sockets", Integer.class, TCPServerConfiguration.class);
	public final static ConfigurationKey HANDLER_MODEL = new ServerConfiguration.ServerConfigurationKey(
			"jgo.net.server.handler_model", Handler.class, TCPServerConfiguration.class);
	static {
