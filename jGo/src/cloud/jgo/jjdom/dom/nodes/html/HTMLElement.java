...
public interface HTMLElement extends Element,Home{
	 ...
	 * @param idElement the element id
	...
	static class HTMLElementType implements Serializable{
		...
		public final static HTMLElementType[]availableTypes = {
				HTML,
				HEAD,
				TITLE,
				SCRIPT,
		...
		public boolean equals(Object obj) {
			...
			if (this.tagName.equals(cast.tagName)&&
				this.hasClosingTag==cast.hasClosingTag&&
