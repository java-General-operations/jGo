...
public interface HTMLDocument extends Document, Home {
	 ...
	 */
	public abstract Elements getElementsByType(HTMLElement.HTMLElementType type); // restituisce il primo elemento che
																					// si trova di quel tipo
	 ...
	 */
	public abstract HTMLElement getStyleTag(); // entra in gioco quando chiamiamo il metodo setminimalTags() però non
												// viene aggiunto, oppure quando l'utente inserisce il tag style viene
												// collegato con la variabile appunto
