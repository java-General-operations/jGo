...
public class HTMLDefaultDocument implements HTMLDocument{
	...
	// e cioè un elemento che possiamo benissimo creare con il metodo che chiede come parag
	// il tipo, ci restituisce null, ciò vuol dire che con questo metodo possiamo creare solo
